...
action_11 (5) = happyGoto action_6
...
happyReduction_4 (HappyAbsSyn6  happy_var_3)
	...
	(HappyAbsSyn6  happy_var_1)
	 =  HappyAbsSyn5
		 (Conv' happy_var_1 happy_var_3
	)
happyReduction_4 _ _ _  = notHappyAtAll 

happyReduce_5 = happySpecReduce_3  6 happyReduction_5
happyReduction_5 (HappyTerminal (TINT happy_var_3))
	_
	(HappyTerminal (TSYM happy_var_1))
	 =  HappyAbsSyn6
		 (Layer' happy_var_1 happy_var_3
	)
happyReduction_5 _ _ _  = notHappyAtAll 

happyReduce_6 = happySpecReduce_1  6 happyReduction_6
happyReduction_6 (HappyTerminal (TSYM happy_var_1))
	 =  HappyAbsSyn6
		 (Neuron' happy_var_1
	)
